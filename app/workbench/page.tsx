              ...
              <div className="case-document-shell">
                {activeSelectedCase.asset?.contentStatus === "indexed" ? (
                  <div className="mx-auto mt-8 w-[min(680px,calc(100%-32px))] rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
                    ...
                    {activeSelectedCase.sourceUrl && <a href={activeSelectedCase.sourceUrl} target="_blank" rel="noreferrer" className="mt-5 inline-flex rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold text-teal-700 hover:bg-teal-50">查看当前来源线索</a>}
                  </div>
